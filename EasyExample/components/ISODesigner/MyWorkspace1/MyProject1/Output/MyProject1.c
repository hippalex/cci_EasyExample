...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(WorkingSet_0), TYPEID_WORKSET, COLOR(187), 1, ID(DataMask_Home), 1, 0, 2,
		...
		'e', 'n',
		'd', 'e',
	ID(Macro_S2), TYPEID_MACRO, WORD(8),
	...
	ID(Macro_S1), TYPEID_MACRO, WORD(16),
		...
		CMD_CONTROL_AUDIO_DEVICE, 3, WORD(440), WORD(100), WORD(100)
	ID(Macro_3), TYPEID_MACRO, WORD(24),
		CMD_HIDE_SHOW, ID(Container_Gesamtzaehler), True, 0xFF, 0xFF, 0xFF, 0xFF,
		CMD_HIDE_SHOW, ID(Container_Tageszaehler), True, 0xFF, 0xFF, 0xFF, 0xFF,
		CMD_CONTROL_AUDIO_DEVICE, 2, WORD(440), WORD(1000), WORD(1000)
	ID(Macro_4), TYPEID_MACRO, WORD(9),
		CMD_CHANGE_CHILD_POSITION, ID(Container_Gesamtzaehler), ID(Button_Reset_Gesamtzaehler), WORD(5), WORD(0),
	ID(Macro_5), TYPEID_MACRO, WORD(0),
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 10, 0, 
		...
		XYREF(Button_S2, 393, 120),
		XYREF(Button_S3, 399, 49),
		XYREF(Button_S4, 401, 197),
	ID(DataMask_S2), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 1, 0, 
		XYREF(Button_S1, 21, 24),
	...
	ID(Button_S2), TYPEID_BUTTON, WORD(77), WORD(72), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_S2, -4, 22),
		MACRO(EV_KEYRELEASE, Macro_S2),
	ID(Button_S1), TYPEID_BUTTON, WORD(81), WORD(73), 27, 4, 1, 0, 1, 1, 
		XYREF(OutputString_11006, -4, 23),
		MACRO(EV_KEYRELEASE, Macro_S1),
	ID(Button_S3), TYPEID_BUTTON, WORD(74), WORD(72), 3, 249, 1, 1, 1, 2, 
		XYREF(OutputString_S3, -4, 22),
		MACRO(EV_KEYPRESS, Macro_4),
		MACRO(EV_KEYRELEASE, Macro_5),
	ID(Button_S4), TYPEID_BUTTON, WORD(64), WORD(41), 57, 6, 1, 0, 1, 1, 
		XYREF(OutputString_S4, -4, 7),
	...
	ID(OutputString_S2), TYPEID_OUTSTR, WORD(77), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_11006), TYPEID_OUTSTR, WORD(81), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'S', '1', ' ', ' ', 0,
	ID(OutputString_S3), TYPEID_OUTSTR, WORD(74), WORD(20), COLOR_BLACK, ID(FontAttributes_23000), 3,
		ID(ID_NULL), 5, WORD(4), 'S', '3', ' ', ' ', 0,
	ID(OutputString_S4), TYPEID_OUTSTR, WORD(64), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'S', '4', ' ', ' ', 0,
