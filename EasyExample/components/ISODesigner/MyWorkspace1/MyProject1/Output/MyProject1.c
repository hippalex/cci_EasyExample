...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(Macro_4), TYPEID_MACRO, WORD(24),
		...
		CMD_CONTROL_AUDIO_DEVICE, 1, WORD(440), WORD(1000), WORD(0)
	ID(Macro_5), TYPEID_MACRO, WORD(24),
